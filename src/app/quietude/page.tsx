        ...
        <header className="text-center pt-12 pb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="group inline-flex items-center gap-3 border border-[#c9a96e]/30 text-[#c9a96e] px-7 py-3.5 rounded-full text-sm tracking-wider hover:bg-[#c9a96e]/10 transition-all"
            >
